...
$routes->get('Grafana','Front::show_grafana');
...
//Master Section Routing
$routes->get('Master-Raw-Data','Master::index');
$routes->get('View-Input','Master::show_view_input');
$routes->get('insert-master-raw-data','Master::input_raw_data');
//Add by DY
//Capacity Utilization
$routes->get('Capacity-Util','CapacityUtil::show_cap_util');
$routes->get('TestUtil','CapacityUtil::y_util');
$routes->get('export-excel-util','CapacityUtil::export_excel_util');

//Production Output
$routes->get('Production-Output','ProdOutput::show_prod_out');
//Pharma dash
//$routes->get('PharmaDash','Front::show_layouts_hori_preloader');
$routes->get('PharmaDash','Front::show_dashboard_saas');

//ViewD Section Routing
$routes->get('KPI-To-Target','ViewD::show_kpi_to_target');
$routes->get('Dashboard','ViewD::show_dashboard');
$routes->get('export-excel','ViewD::export_excel');
$routes->get('kpi-export-excel','ViewD::export_excel_kpi');
$routes->get('raw-export-excel','Master::export_excel_raw');
$routes->get('delete-kpi','ViewD::delete_kpi');
// $routes->add('calculate/param1','ViewD::calculate_kpi');
