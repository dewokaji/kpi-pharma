                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        <?php foreach ($datas as $row){?>
                            <input type="hidden" id="<?php echo($row['id']) ?>-1" name="<?php echo($row['id']) ?>-1" value="<?php echo($row['MTD'])?>"/>
                            <input type="hidden" id="<?php echo($row['id']) ?>-2" name="<?php echo($row['id']) ?>-2" value="<?php echo($row['YTD'])?>"/>
                        <?php } ?>

                        <?php foreach ($datag as $row){?>
                            <input type="hidden" id="<?php echo($row['id']) ?>" name="<?php echo($row['id']) ?>" value="<?php echo($row['result'])?>"/>
                        <?php } ?>
                        
                        <?php foreach ($dataraw1 as $row){?>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-a" name="<?php echo($row['idRawData']) ?>-a" value="<?php echo(number_format($row['tResult'],1))?>"/>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-a-1" name="<?php echo($row['idRawData']) ?>-a" value="<?php echo($row['tResult'])?>"/>
                        <?php } ?>

                        <?php foreach ($dataraw2 as $row){?>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-b" name="<?php echo($row['idRawData']) ?>-b" value="<?php echo(number_format($row['tResult'],1))?>"/>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-b" name="<?php echo($row['idRawData']) ?>-b" value="<?php echo($row['tResult'])?>"/>
                        <?php }?>
                        
                        <?php foreach ($datau as $row){?>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-u" name="<?php echo($row['idRawData']) ?>-u" value="<?php echo(number_format($row['tResultMTD'],1))?>">
                        <?php }?>

                        <?php foreach ($datarawkpi as $row){?>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-k" name="<?php echo($row['idRawData'])?>-k" value="<?php echo($row['tResultMTD']) ?>">
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-l" name="<?php echo($row['idRawData'])?>-l" value="<?php echo($row['tResultYTD']) ?>">
                        <?php }?>

                        <?php foreach ($datarawgrafik as $row){ ?>
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-m" name="<?php echo($row['idRawData'])?>-m" value="<?php echo($row['tResultMTD'])?>">
                            <input type="hidden" id="<?php echo($row['idRawData'])?>-n" name="<?php echo($row['idRawData'])?>-n" value="<?php echo($row['tResultYTD'])?>">
                        <?php }?>
